...
object PersonData {
  ...
  val bob = new Person(id = 1, name = "Mr Bob", age = 35, motto = "When the world gives you lemons, throw them at people", isHungry = false, img = bobImage, diary = bobDiary)
  ...
  val jones = new Person(id = 2, name = "Mrs Jones", age = 57, motto = "You can never have enough cats", isHungry = true, img = jonesImage, diary = jonesDiary)
